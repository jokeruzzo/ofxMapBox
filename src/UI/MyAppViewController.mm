...
- (void)loadView {
    ...
    MapBoxAppViewController *viewController;
    viewController = [[[MapBoxAppViewController alloc] initWithFrame:[[UIScreen mainScreen] bounds]
                                                                 app:new MapBoxApp()] autorelease];
